    ...
    <div className="min-h-screen pt-20">
      ...
      <div className="py-24 px-6 bg-white border-t border-slate-100">
         <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="h-64 bg-slate-100 rounded-[3rem] animate-pulse flex items-center justify-center text-slate-400 font-bold text-xs uppercase tracking-widest">
